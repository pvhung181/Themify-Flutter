...
mixin _$CommonState {
 ...
 AppExceptionWrapper? get appExceptionWrapper; int get loadingCount; bool get isLoading;
...
@override
int get hashCode => Object.hash(runtimeType,appExceptionWrapper,loadingCount,isLoading);
...
@useResult
$Res call({
 AppExceptionWrapper? appExceptionWrapper, int loadingCount, bool isLoading
});
...
/// Create a copy of CommonState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? appExceptionWrapper = freezed,Object? loadingCount = null,Object? isLoading = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( AppExceptionWrapper? appExceptionWrapper,  int loadingCount,  bool isLoading)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CommonState() when $default != null:
return $default(_that.appExceptionWrapper,_that.loadingCount,_that.isLoading);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( AppExceptionWrapper? appExceptionWrapper,  int loadingCount,  bool isLoading)  $default,) {final _that = this;
switch (_that) {
case _CommonState():
return $default(_that.appExceptionWrapper,_that.loadingCount,_that.isLoading);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( AppExceptionWrapper? appExceptionWrapper,  int loadingCount,  bool isLoading)?  $default,) {final _that = this;
switch (_that) {
case _CommonState() when $default != null:
return $default(_that.appExceptionWrapper,_that.loadingCount,_that.isLoading);case _:
  return null;
...
class _CommonState extends CommonState {
  const _CommonState({this.appExceptionWrapper, this.loadingCount = 0, this.isLoading = false}): super._();
...
/// Create a copy of CommonState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? appExceptionWrapper = freezed,Object? loadingCount = null,Object? isLoading = null,}) {
